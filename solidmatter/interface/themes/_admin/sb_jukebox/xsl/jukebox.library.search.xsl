	...
	<body>
		...
		<div class="workbench">
			...
			<xsl:call-template name="renderResult">
				...
				<xsl:with-param name="type" select="'sbJukebox_Artist'" />
			</xsl:call-template>
			<xsl:call-template name="renderResult">
				...
				<xsl:with-param name="type" select="'sbJukebox_Album'" />
			</xsl:call-template>
			<xsl:call-template name="renderResult">
				...
				<xsl:with-param name="type" select="'sbJukebox_Track'" />
			</xsl:call-template>
		</div>
	</body>
	</html>
					...
					<xsl:when test="$nodes">
						<xsl:for-each select="$nodes">
							<tr>
								...
								<td>
									<a href="/{@uuid}" class="highlighted" style="display:block;"><xsl:value-of select="@label" /></a>
								</td>
							</tr>
						</xsl:for-each>
					</xsl:when>
