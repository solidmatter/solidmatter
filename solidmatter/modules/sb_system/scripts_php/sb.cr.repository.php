		...
		if ($bAsArray == FALSE) {
			...
			$aPropertyDefinitions = array(
				...
				'uuid' => array(
					...
					's_labelpath' => '$locale/system/general/labels/label',
				...
				'nodetype' => array(
					...
					's_internaltype' => 'string',
					'b_showinproperties' => 'FALSE',
					's_labelpath' => '$locale/system/general/labels/nodetype',
					's_descriptionpath' => NULL,
					'b_multiple' => 'FALSE',
					'e_storagetype' => 'PRIMARY',
				...
				'name' => array(
					...
					'b_showinproperties' => 'TRUE',
					's_labelpath' => '$locale/system/general/labels/urlname',
					's_descriptionpath' => NULL,
					'b_multiple' => 'FALSE',
					'e_storagetype' => 'PRIMARY',
					's_auxname' => 's_name',
				...
				'csstype' => array(
					...
					's_internaltype' => 'string',
					'b_showinproperties' => 'FALSE',
					's_labelpath' => '$locale/system/general/labels/',
					's_descriptionpath' => NULL,
					'b_multiple' => 'FALSE',
					'e_storagetype' => 'PRIMARY',
					's_auxname' => 's_csstype',
