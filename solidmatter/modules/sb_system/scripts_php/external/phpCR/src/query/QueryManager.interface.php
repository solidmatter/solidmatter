...
require_once PHPCR_PATH . '/query/InvalidQueryException.exception.php';
require_once PHPCR_PATH . '/Node.interface.php';
require_once PHPCR_PATH . '/exceptions/RepositoryException.exception.php';
require_once PHPCR_PATH . '/query/Query.interface.php';
