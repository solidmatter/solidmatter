...
require_once PHPCR_PATH . '/NodeIterator.interface.php';
require_once PHPCR_PATH . '/PropertyIterator.interface.php';
require_once PHPCR_PATH . '/query/RowIterator.interface.php';
