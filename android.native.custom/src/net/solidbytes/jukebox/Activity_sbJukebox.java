...
public class Activity_sbJukebox extends TabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		intent = new Intent().setClass(this, Activity_Albums.class);
		spec = tabHost.newTabSpec("albums").setIndicator("Albums",
				res.getDrawable(R.drawable.ic_tab_albums))
				.setContent(intent);
		tabHost.addTab(spec);

		intent = new Intent().setClass(this, Activity_Charts.class);
