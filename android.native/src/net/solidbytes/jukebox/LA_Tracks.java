...
public class LA_Tracks extends ArrayAdapter<Node_Track> {
	
	public LA_Tracks(Activity activity, List<Node_Track> lTracks) {
...
//		vLength.setText(oCurrent.getProperty("info_playtime"));
		...
		Node_Track nodeCurrent = getItem(position);
		return (nodeCurrent.getView(Node_Track.ROW_NUMBERED));
