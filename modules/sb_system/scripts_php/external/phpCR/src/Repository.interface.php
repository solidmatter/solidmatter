...
require_once PHPCR_PATH . '/exceptions/LoginException.exception.php';
require_once PHPCR_PATH . '/exceptions/NoSuchWorkspaceException.exception.php';
...
interface Repository
{
	 ...
	 */
	public function login($credentials, $workspaceName);
}
